...
namespace Car_GameBoy._1_Deps.Levels
{
    internal class Level_3 : I_Level_Runnable
    {
        public void Run()
        {
            ...
            /// GameArea
            Globals.gameArea_Bkground_Color = Brushes.White;
            //-----------
            Globals.timerTick = 150;
            //-----------
            /// Racing Area
            Globals.racing_Area_bGround_Color = Brushes.Black;
            /// Racing Area Bkg Lines
            Globals.moving_Increment = 30;
            ...
            //-------------------------------------------------
            ///Enemyies
            Globals.number_Of_Enemies = 6;
            Globals.vertical_Dis_Bet_Enemies = 80;
            Globals.enemy_Move_Speed = 30;
